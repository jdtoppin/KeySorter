...
function KS.CreateAboutView(parent)
    ...
    AddText("|cff00ff00/ks announce|r  Post all groups to raid chat")
    AddText("|cff00ff00/ks announce N|r  Post group N to raid chat")
    AddText("|cff00ff00/ks sync|r  Force sync groups to assistants (normally automatic)")
